...
public class UnifiedOrderReqData {
     ...
     * @param fee_type 货币类型
     * @param total_fee 总金额，单位为“分”，只能整数
     * @param spbill_create_ip 订单生成的机器IP
     * @param time_start 订单生成时间， 格式为yyyyMMddHHmmss，如2009年12 月25 日9 点10 分10 秒表示为20091225091010。时区为GMT+8 beijing。该时间取自商户服务器
     ...
     * @param openid 用户标识
     * @param sub_openid 用户子标识
     * @param keyPartner 秘钥
     */
    public UnifiedOrderReqData(String appid, String mch_id, String sub_appid, String sub_mch_id, String device_info,
			String nonce_str, String sign, String sign_type, String body, String detail, String attach,
			...
			String limit_pay, String openid, String sub_openid,String keyPartner) {
		this.appid = appid;
		this.mch_id = mch_id;
