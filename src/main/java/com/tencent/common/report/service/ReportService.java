...
public class ReportService {
     ...
     */
    public ReportService(ReportReqData reportReqData,String certLocalPath,String certPassword){
    ...
    public String request() throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
        String responseString = new HttpsRequest(certLocalPath,certPassword).sendPost(Configure.REPORT_API, reqData);
     ...
     * @throws Exception
     */
    public static String request(ReportReqData reportReqData,String certLocalPath,String certPassword) throws Exception {

        //--------------------------------------------------------------------
        //发送HTTPS的Post请求到API地址
        //--------------------------------------------------------------------
        String responseString = new HttpsRequest(certLocalPath,certPassword).sendPost(Configure.REPORT_API, reportReqData);
